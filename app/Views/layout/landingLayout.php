    ...
    <section class="ftco-section ftco-about"  id="about">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url('/evolo/images/about.jpg')">
           <!-- <img class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" src="<?php echo base_url('/evolo/images/about.jpg') ?>" alt=""> -->
					</div>
		...
		<!-- <section class="ftco-section ftco-intro" style="background-image: url(/evolo/images/bg_3.jpg);" id="contact"> -->
		<section class="ftco-section ftco-intro" style="background-image: url(/evolo/images/image_1.jpg);" id="contact">
...
<?= $this->include('layout/landingFooter') ?>
